                ...
                <div className="popup">
                    <div className="popup-content">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <input type="text" placeholder="Instrument" name="instrument" />
                            <input type="text" placeholder="Day of Week" name="dayOfWeek" />
                            <input type="text" placeholder="Price" name="price" />
                          <div className='Form-Can-Add' style={{display:'flex' , justifyContent:'end', alignItems:'center', gap:'1.5rem'}}>
                            <h2 style={{cursor:'default'}}>Cancel</h2>
